...
public class EditSessionBinder {
    ...
    public EditSessionBinder(Context context , AppCompatActivity activity, EditViewModule editViewModule) {
        this.activity = activity;
        this.editViewModule = editViewModule;
    ...
    public void showDurationFragment (){
        ...
        dialogBuilder.show(R.id.edit_session_root);
    }
